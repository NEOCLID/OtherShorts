...
# YouTube API
YOUTUBE_API_KEY=AIzaSyB4yCvg8QsEN0S1oB_89-UYIS_6cN3vz1Q
...
## 🚀 Step 5: Add Custom Domain (api.othershorts.com)
...
✅ SSL certificate is automatically generated by Railway!
...
const PROD_API = 'https://api.othershorts.com';  // ← Now this works!

export const API_IP = __DEV__
  ? (typeof document !== 'undefined' ? DEV_API : DEV_MOBILE_API)
  : PROD_API;  // ← Remove the WEB_TEST_API workaround
```
...
1. Click **Settings**
2. **Notifications** → Add your email
...
2. Click `othershorts-db` → **VPC security groups**
...
3. Update in Railway dashboard → **Variables**
4. Delete old key
...
- ✅ Accessible at api.othershorts.com
